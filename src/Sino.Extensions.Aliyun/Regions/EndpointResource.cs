...
namespace Sino.Extensions.Aliyun.Regions
{
    ...
    {
        public static IDictionary<string, string> GlobalEndpoints { get; private set; }

        public static IDictionary<string, string> RegionalEndpoints { get; private set; }

        public static IDictionary<string, string> RegionalEndpointPattern { get; private set; }

        public static IDictionary<string, string> LocationCodeMapping { get; private set; }

        public static IList<string> Regions { get; private set; }
