...
using OrvilleX.Dependency.Resolvers;
    ...
    public class DependencyBuilder : IDependencyBuilder
    {
        ...
        public IServiceProvider Build()
        {
            _container.Register(
                ...
                Component.For<IServiceProvider, ISupportRequiredService>().ImplementedBy<DefaultScopedServiceProvider>().LifeStyle.Scoped<ExtensionContainerScopeAccessor>(),
                Component.For<IServiceScopeFactory>().ImplementedBy<DefaultScopeFactory>().LifestyleSingleton());
