...
namespace OrvilleX.Dependency
{
    ...
    /// 提供依赖注入服务
    /// </summary>
    internal class DefaultScopedServiceProvider : IServiceProvider, ISupportRequiredService, IDisposable
    {
        ...
        public DefaultScopedServiceProvider(IWindsorContainer container)
        {
